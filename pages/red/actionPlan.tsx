...
export default function ActionPage() {
    ...
    return (
        <section className="overflow-hidden grid bg-main-red min-h-screen" style={{backgroundColor: secretMode  ? "#A6A6A6": undefined}}>
             <Header back={true}/>
...
function ActionCard({item, key}: { item: string[], key:number }) {
   ...
   return (
    <div key={index} className="bg-[#F6E0DE] rounded-xl p-4 mr-4 cursor-grab" style={{width: width < breakingPoint ? width - 3*paddingToBorder  + "px": undefined}} >
